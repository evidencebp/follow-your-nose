...
from 
[hotspots-readability:hotspot.java_files_commits_2018] as first
join
[hotspots-readability:hotspot.java_files_commits_2018] as second
on
first.repo_name = second.repo_name
and
first.file = second.file
where
# The month condition should be part of the JOIN condition, not the WHERE condition
...
# month being top 90% hotspot stability
Select
# Top 90% of hit rate.
